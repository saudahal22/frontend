...
export default function Sidebar() {
  ...
  const menuItems = [
    ...
    { href: '/admin-dashboard/profile', label: 'Profil Saya', icon: '👤' },
    { href: '/admin-dashboard/schedule', label: 'kelola pendaftar', icon: '📅' },
    { href: '/admin-dashboard/material', label: 'Soal Tes', icon: '📚' },
    { href: '/admin-dashboard/status', label: 'Status Seleksi', icon: '📊' },
  ];
