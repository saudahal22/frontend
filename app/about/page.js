      ...
      <main className="relative overflow-hidden">
        ...
        <section className="relative pt-24 text-center">
          <div className="container mx-auto px-6">
            <FadeIn>
              <h1 className="text-5xl md:text-7xl font-bold font-playfair mb-6 py-3 bg-gradient-to-l from-blue-800 via-sky-600 to-blue-900 bg-clip-text text-transparent animate-gradient">
                Tentang COCONUT
              </h1>
            </FadeIn>
            <SlideUp delay={200}>
        ...
        <section className="relative py-24">
          <div className="container mx-auto px-6 max-w-6xl">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              {/* Kolom Kiri */}
              <SlideUp delay={200}>
                <div className="bg-gradient-to-br from-white/90 to-sky-50/90 p-8 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 border border-white/50 backdrop-blur-sm">
                  <h3 className="text-xl font-bold text-blue-900 mb-4">Sejarah Singkat</h3>
                  <p className="text-black leading-relaxed">
                    COCONUT (Computer Club Oriented Network, Utility & Technology) berdiri pada tahun 2008 di STMIK Profesional Makassar. Awalnya sebagai klub komputer kampus, kini berkembang menjadi komunitas teknologi lintas universitas yang aktif dalam penelitian, pengembangan, dan kolaborasi teknologi tingkat nasional maupun internasional. 
                  </p>
                </div>
              </SlideUp>
              ...
              <SlideUp delay={300}>
                <div className="bg-gradient-to-br from-white/90 to-sky-50/90 p-8 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 border border-white/50 backdrop-blur-sm">
                  <h3 className="text-xl font-bold text-blue-900 mb-4">Dampak</h3>
                  <p className="text-black leading-relaxed">
                    Dengan fokus yang kuat pada riset dan pengembangan teknologi informasi, COCONUT berkomitmen membina dan memberdayakan generasi muda untuk menjadi talenta unggul di bidang teknologi. Melalui program pelatihan intensif, webinar inspiratif, dan proyek kolaboratif berskala nasional dan internasional.</p>
                </div>
              </SlideUp>
            </div>
          </div>
            ...
            <FadeIn>
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-black max-w-3xl mx-auto">
                  Dari klub kecil hingga menjadi komunitas teknologi terdepan dan terbesar di Sulawesi Selatan
                </p>
              </div>
            </FadeIn>
              ...
              {[
                ...
                <SlideUp key={index} delay={150 * index}>
                  <div className="flex flex-col h-full p-6 bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 border border-gray-100 text-center">
                    ...
                    <p className="text-sm text-black leading-relaxed mt-auto">{item.desc}</p>
                  </div>
                </SlideUp>
              ))}
            </div>
                ...
                <div className="bg-gradient-to-br from-white/90 to-sky-50/90 p-8 rounded-3xl shadow-xl border border-white/60 backdrop-blur-sm">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-black leading-relaxed">{visionMission.vision}</p>
                    </div>
                  </div>
                </div>
              </SlideUp>
                ...
                <div className="bg-gradient-to-br from-white/90 to-sky-50/90 p-8 rounded-3xl shadow-xl border border-white/60 backdrop-blur-sm">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-black leading-relaxed">{visionMission.mission}</p>
                    </div>
                  </div>
                </div>
              </SlideUp>
                ...
                <SlideUp key={index} delay={200 * index}>
                  <div className="group relative flex flex-col h-full">
                    ...
                    <div className="relative bg-gradient-to-br from-white/90 to-sky-50/90 p-8 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-3 border border-white/50 backdrop-blur-sm text-center flex-1 flex flex-col">
                      ...
                      <p className="text-black leading-relaxed text-sm mt-auto">{focus.desc}</p>
                    </div>
                  </div>
                </SlideUp>
              ))}
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto mb-12">
              ...
              <SlideUp delay={200}>
                <div className="group bg-gradient-to-br from-white/90 to-sky-50/90 p-8 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border border-white/50 backdrop-blur-sm">
                  ...
                  <div className="relative z-10">
                    <h3 className="text-2xl font-bold text-blue-900 mb-4">Dukungan Pendanaan</h3>
                    <p className="text-black leading-relaxed">
                      Kami mendapatkan dukungan pendanaan dari berbagai organisasi, termasuk <strong>Center for Open Science</strong>, yang memungkinkan kami menjalankan proyek riset dan pengembangan teknologi secara berkelanjutan.
                    </p>
                  </div>
                </div>
              </SlideUp>
              ...
              <SlideUp delay={300}>
                <div className="group bg-gradient-to-br from-white/90 to-sky-50/90 p-8 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border border-white/50 backdrop-blur-sm">
                  <div className="absolute inset-0 bg-gradient-to-br from-sky-100/50 to-blue-100/30 rounded-3xl opacity-0 group-hover:opacity-100 blur-sm transition-opacity duration-300"></div>
                  <div className="relative z-10">
                    <h3 className="text-2xl font-bold text-blue-900 mb-4">Pemberi Dana</h3>
                    <p className="text-black leading-relaxed">
                      Anda dapat melihat daftar para pemberi dana kami di bawah ini, yang selama ini telah berkontribusi besar dalam mendukung berbagai kegiatan dan program kami, yaitu <strong className="font-bold">LONTAR dan Algo</strong> sebagai mitra utama.
                    </p>
                  </div>
                </div>
              </SlideUp>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
              ...
              <SlideUp delay={400}>
                <div className="group bg-gradient-to-br from-white/90 to-sky-50/90 p-8 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border border-white/50 backdrop-blur-sm">
                  <div className="absolute inset-0 bg-gradient-to-br from-sky-100/50 to-blue-100/30 rounded-3xl opacity-0 group-hover:opacity-100 blur-sm transition-opacity duration-300"></div>
                  <div className="relative z-10">
                    <h3 className="text-2xl font-bold text-blue-900 mb-4">Jaringan Kerja Sama</h3>
                    <p className="text-black leading-relaxed">
                      Kami berkolaborasi dengan berbagai peneliti, lembaga, konferensi, dan organisasi dari dalam dan luar negeri.
                    </p>
                  </div>
                </div>
              </SlideUp>
              ...
              <SlideUp delay={500}>
                <div className="group bg-gradient-to-br from-white/90 to-sky-50/90 p-8 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border border-white/50 backdrop-blur-sm">
                  <div className="absolute inset-0 bg-gradient-to-br from-sky-100/50 to-blue-100/30 rounded-3xl opacity-0 group-hover:opacity-100 blur-sm transition-opacity duration-300"></div>
                  <div className="relative z-10">
                    <h3 className="text-2xl font-bold text-blue-900 mb-4">Mitra Kolaborasi</h3>
                    <p className="text-black leading-relaxed">
                     Termasuk IDSECCONF, MEH Labs, PT Lontar Riset Indonesia, AI Research Indonesia, dan masih banyak lagi.
                    </p>
                  </div>
                </div>
              </SlideUp>
            ...
            <SlideUp delay={600} className="max-w-5xl mx-auto mt-16">
              <div className="bg-gradient-to-br from-white/90 to-sky-50/90 p-8 rounded-3xl backdrop-blur-sm border border-white/60 shadow-2xl">
                <div className="mb-8">
                  <h3 className="text-2xl font-bold text-blue-900 mb-4">Lingkar Konektivitas</h3>
                  <p className="text-lg text-black mb-6 leading-relaxed">
                    Menghubungkan berbagai mahasiswa dari beberapa kampus untuk berkolaborasi, berinovasi, dan berkembang bersama.:
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 gap-4 ">
                  {[
                    ...
                    { name: 'Universitas Hasanuddin', abbr: 'UNHAS', students: '50+ mahasiswa' },
                    { name: 'Universitas Negeri Makassar', abbr: 'UNM', students: '30+ mahasiswa' },
                    { name: 'Universitas Islam Negeri', abbr: 'UIN', students: '20+ mahasiswa' },
                    { name: 'Universitas Muhammadiyah', abbr: 'UNISMUH', students: '20+ mahasiswa' },
                    { name: 'Universitas Muslim Indonesia', abbr: 'UMI', students: '10+ mahasiswa', abbr: 'UMI', students: '5+ mahasiswa' },
                  ].map((uni, index) => (
                    <div
                      key={index}
                    ...
                    >
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <span className="text-sm text-black font-medium">({uni.abbr})</span>
                        </div>
                      </div>
                      {uni.students && (
